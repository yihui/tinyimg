...
This package uses Rust for image optimization. The package includes vendored Rust dependencies (via vendor.tar.xz in the source tarball) to comply with CRAN policies and ensure reproducible builds. The Rust compiler and Cargo are required as SystemRequirements for building from source.
