...
Note: The `.cargo/config.toml` file is automatically generated by the `configure` script during package installation, so you don't need to create it manually.
...
# Note: configure script will create .cargo/config.toml during build
